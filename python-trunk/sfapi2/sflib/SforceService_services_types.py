...
class urn_sobject_partner_soap_sforce_com:
    ...
    class sObject_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [ZSI.TC.String(pname="type",aname="_type", repeatable=1, optional=1)
                    , ZSI.TC.String(pname="fieldsToNull",aname="_fieldsToNull", repeatable=1, optional=1)
                    , ns1.ID_Def(name="Id",ns=ns, optional=1)
                    #, ZSI.TC.String(pname="Description",aname="_Description", repeatable=0, optional=1)
                    , ZSI.TC.Any(pname="",aname="", repeatable=1, optional=1), ]
