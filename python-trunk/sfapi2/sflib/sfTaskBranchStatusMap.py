...
class SFTaskBranchStatus:
    ...
    def getStatusMap(self):
        ...
        statMap['Approving by Partition Reviewer']         = {'order':33.5, 'role':'part', 'crStatus':'Fixing', 'crStatusFirst':'Fixing'}
        statMap['Approved by Partition Reviewer']          = {'order':33.7, 'role':'part', 'crStatus':'Fixing', 'crStatusFirst':'Fixing'}

        statMap['Approving by Manager']         = {'order':34.0, 'role':'mgr', 'crStatus':'Fixing', 'crStatusFirst':'Fixing'}
        statMap['Approved by Manager']          = {'order':34.2, 'role':'mgr', 'crStatus':'Fixing', 'crStatusFirst':'Fixing'}
        statMap['Approving by PE']              = {'order':35.0, 'role':'pe',  'crStatus':'Fixing', 'crStatusFirst':'Fixing'}
        statMap['Approved by PE']               = {'order':35.2, 'role':'pe',  'crStatus':'Fixing', 'crStatusFirst':'Fixing'}
        

        #statMap['Approving by Partition Reviewer']         = {'order':33.5, 'role':'part', 'crStatus':'Approving', 'crStatusFirst':'First-Approving'}
        #statMap['Approved by Partition Reviewer']          = {'order':33.7, 'role':'part', 'crStatus':'Approving', 'crStatusFirst':'First-Approving'}

        #statMap['Approving by Manager']         = {'order':34.0, 'role':'mgr', 'crStatus':'Approving', 'crStatusFirst':'First-Approving'}
        #statMap['Approved by Manager']          = {'order':34.2, 'role':'mgr', 'crStatus':'Approving', 'crStatusFirst':'First-Approving'}
        #statMap['Approving by PE']              = {'order':35.0, 'role':'pe',  'crStatus':'Approving', 'crStatusFirst':'First-Approving'}
        #statMap['Approved by PE']               = {'order':35.2, 'role':'pe',  'crStatus':'Approving', 'crStatusFirst':'First-Approving'}
