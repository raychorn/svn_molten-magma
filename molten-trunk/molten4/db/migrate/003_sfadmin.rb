...
class Sfadmin < ActiveRecord::Migration
    ...
    @commentdesc=Attachment.connection.get_entity_def("CaseComment")
    @commentcol=@commentdesc.columns    
    
    @catDatadesc=CategoryData.connection.get_entity_def("CategoryData")
    @catDatacol=@catDatadesc.columns    
    
    @catNodedesc=CategoryNode.connection.get_entity_def("CategoryNode")
    @catNodecol=@catNodedesc.columns    
  ...
  def self.up
   ...
   def self.down
     ...
     drop_table "sfattach"
     drop_table "sfccomment"
     drop_table "sfcatdata"
     drop_table "sfcatnode"
   end
end
