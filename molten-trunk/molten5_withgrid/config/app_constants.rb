...
#  APP_NAME = "MOLTEN – Magma Design Automation, Inc."
  ...
  SHUTDOWN_DATES = [Date.strptime('09/02/2008',fmt='%m/%d/%Y'),Date.strptime('09/06/2008',fmt='%m/%d/%Y')]
  #SHUTDOWN_NOTICE = "Dear Customer,<br><br>Magma Design Automation Inc is observing a shutdown from 6/28 to 7/6. MOLTEN USA support during this time will be at minimal and only MOLTEN INDIA team would be active. Please expect delays in responses.<br><br>Thank you for your co-operation and understanding.<br><br>Sincerely,<br>MOLTEN TEAM USA"
